...
export default function ChatInterface({ selectedDocument, messages, onMessagesChange }: ChatInterfaceProps) {
  ...
  const exampleQueries = [
    'What are the KYC requirements for new customer onboarding?',
    'Check if our vendor outsourcing agreement is compliant',
    'What are the AML reporting obligations?',
    'Explain data protection requirements for customer information',
  ];
