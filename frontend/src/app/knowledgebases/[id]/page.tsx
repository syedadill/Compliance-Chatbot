...
import { getKnowledgebase } from "@/lib/knowledgebaseApi";
import Header from "@/components/Header";
import axios from "axios";
import { 
  ArrowLeft, Upload, FileText, CheckCircle, Clock, 
  AlertCircle, Play, Trash2, MessageCircle, RefreshCw 
} from "lucide-react";
          ...
          <div className="bg-white rounded-xl border border-hbl-gray-200 p-6 mb-6 shadow-sm">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <h1 className="text-3xl font-bold text-hbl-gray-900 mb-2">{kb.name}</h1>
