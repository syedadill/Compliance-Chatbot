...
const CreateComplianceKnowledgebasePage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/compliance/knowledgebases/${kb.id}`);
    } catch (err: any) {
        ...
        <div className="max-w-2xl mx-auto px-6 py-8">
          ...
          <div className="bg-white rounded-xl border border-hbl-gray-200 p-8 shadow-sm">
            <div className="flex items-center space-x-4 mb-6">
              ...
              <div>
                <h1 className="text-2xl font-bold text-hbl-gray-900">Create Compliance Knowledgebase</h1>
                <p className="text-hbl-gray-600">Add a new knowledgebase for compliance documents</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., SBP Regulations 2024"
                  className="w-full px-4 py-3 border border-hbl-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-hbl-green focus:border-transparent"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="w-full px-4 py-3 border border-hbl-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-hbl-green focus:border-transparent resize-none"
                />
              </div>
              ...
              <div className="flex items-center justify-end space-x-4 pt-4">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="flex items-center space-x-2 px-6 py-3 bg-hbl-green text-white rounded-lg hover:bg-hbl-green-dark transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
...
export default CreateComplianceKnowledgebasePage;
